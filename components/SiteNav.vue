<template>
  <nav class="bg-indigo-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-indigo-700">
      <div class="flex justify-between h-16">
        <div class="flex">
          <!-- Mobile menu button -->
          <div class="-ml-2 mr-2 flex items-center md:hidden">
            <button
              class="inline-flex items-center justify-center p-2 rounded-md text-indigo-400 hover:text-white hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700 focus:text-white transition duration-150 ease-in-out"
          ...
          <nuxt-link :to="localePath('/')" class="flex-shrink-0 flex items-center">
            ...
            <div class="hidden lg:block pl-4 text-indigo-300 text-2xl">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:ml-4 md:flex-shrink-0 md:flex md:items-center">
            <div class="relative">
              ...
              <div>
                <button
                  class="flex text-2xl text-indigo-300 focus:outline-none focus:text-white transition duration-150 ease-in-out"
                  id="user-menu"
...
<style scoped>
.nav-h {
  @apply ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-indigo-300;
...
.address-mainnet {
  @apply py-2 px-4 bg-indigo-700 rounded-md font-mono text-sm text-indigo-300;
}

.address-testnet {
  @apply py-2 px-4 bg-indigo-700 rounded-l-md font-mono text-sm text-indigo-300;
}

.testnet-name {
  @apply py-2 px-4 bg-orange-500 rounded-r-md font-mono text-sm text-indigo-50;
}
